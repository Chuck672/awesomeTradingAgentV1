...
class AppConfigStore:
    ...
    def _get_default_base_dir(self) -> str:
        ...
        if system == "Windows":
            ...
            return os.path.join(appdata, "AwesomeTradingAgent", "data")
        elif system == "Darwin": # macOS
            return os.path.join(os.path.expanduser("~"), "Library", "Application Support", "AwesomeTradingAgent", "data")
        else: # Linux / other
            return os.path.join(os.path.expanduser("~"), ".config", "AwesomeTradingAgent", "data")
